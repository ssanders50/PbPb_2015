...
process.vnanalyzer.chi2 = cms.untracked.double(7.0)
process.vnanalyzer.dzdzerror_pix = cms.untracked.double(5.0)
process.vnanalyzer.dzdzerror_ = cms.untracked.double(1.5)
process.vnanalyzer.d0d0error_ = cms.untracked.double(1.5)
process.vnanalyzer.pterrorpt_ = cms.untracked.double(0.04)
