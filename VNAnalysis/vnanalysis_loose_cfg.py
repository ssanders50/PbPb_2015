...
process.vnanalyzer.chi2 = cms.untracked.double(18.0)
process.vnanalyzer.dzdzerror_pix = cms.untracked.double(10.0)
process.vnanalyzer.dzdzerror_ = cms.untracked.double(5.0)
process.vnanalyzer.d0d0error_ = cms.untracked.double(5.0)
